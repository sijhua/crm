    ...
    <el-container>
      <el-main>
        <div class="addContactbutton">
          ...
          <addContact :visivle.sync="visivle" @change="fetchData()"></addContact>
        </div>
...
.dialog .el-dialog {
  ...
  /*修改table 的背景颜色和文字颜色*/
.el-table th.is-leaf,.el-table--border, .el-table--group{
  border-color: rgba(122, 188, 216, 0.6);
  background-color: rgba(122, 188, 216, 0.6);
...
.el-table tbody tr:hover>td {
  background-color:rgb(235, 208, 207)!important
}
</style>