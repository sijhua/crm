              ...
              <div class="user-item">
                ...
                >
                  <el-form
                    ...
                    ref="emailForm"
                  >
                    <el-form-item label="new email" prop="input">
                      <el-input
                        v-model="emailForm.input"
...
export default {
  ...
  methods: {
    ...
    async updateEmail() {
      this.$refs.emailForm.validate((v) => {
        if (v) {
          this.$axios
            .put(this.$path.LOGIN + "/" + sessionStorage.id, {
              email: this.emailForm.input,
            })
            .then((res) => {
              if (res.data.code === 200) {
                this.$message.success(res.data.msg);
                this.DialogVisible = false;
                this.email = this.emailForm.input;
                sessionStorage.email = this.emailForm.input;
              }
            });
        }
      });
