<template>
  <div class="contact">
    ...
    <el-dialog title="Add contact" :visible.sync="dialogFormVisible">
      <el-form :model="form" ref="addForm">
            ...
            },
            {
              validator: (rule, value, callback) => {
                if (/\d{10}/.test(value)) {
                  ...
                  callback('incrrect phone number');
                }
              },
              trigger: 'blur',
            },
        ...
        <el-form-item :label-width="formLabelWidth" label="tags">
          ...
          <span v-for="item in checkList" style="margin:10px;">{{item}}</span>
          <el-button @click="handleChooseTag">choose tags</el-button>
        </el-form-item>
    ...
    <el-dialog title="notice" :visible.sync="dialogVisible2" width="30%">
