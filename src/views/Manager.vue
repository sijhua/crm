  ...
  <el-container id="index-container">
    ...
    <el-container>
      <el-main>
        ...
        >
          <el-table-column label="email" width="100" prop="email">
          </el-table-column>
          <el-table-column prop="name" label="name" width="250">
            <template #default="o">
              {{ o.row.firstName + " " + o.row.lastName }}
            </template>
          </el-table-column>
          <el-table-column label="update" width="250">
            <template #default="o">
              <el-button type="text" @click="handleUpdatePassword(o.row._id)">
                update password
              </el-button>
            </template>
          </el-table-column>
          <el-table-column label="reset" width="250">
            <template #default="o">
              <el-button type="text" @click="handleResetPassword(o.row._id)">
                reset password
              </el-button>
            </template>
          </el-table-column>
        ...
        <div class="dialog">
          <el-dialog :visible.sync="dialogVisible" width="40%">
            <template slot="title">
              <div class="delete-title">update</div>
            </template>
            <el-form label-width="80px">
              <el-form-item>
                <el-input type="text" v-model="newpass"></el-input>
              </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
              <el-button @click="handleUpdateYes">Yes</el-button>
...
export default {
  ...
  methods: {
    ...
    async handleUpdateYes() {
      let res = await this.$axios.put(this.url + "/" + this.updateId,{password:this.newpass});
      if (res.data.code === 200) {
        this.$message.success("success");
